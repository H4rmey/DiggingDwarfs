...
namespace SharpDiggingDwarfs.Brush
{
    ...
    public class BrushManager
    {
        ...
        private PixelElementComposed[] availablePixelTypes;
        
        public IBrush CurrentBrush => availableBrushes[currentBrushIndex];
        public int CurrentSize => currentSize;
        public PixelElementComposed CurrentPixelType => availablePixelTypes[currentPixelTypeIndex];
        ...
        public BrushManager()
        {
            ...
            availablePixelTypes = new PixelElementComposed[]
            {
        ...
        /// </summary>
        public PixelElementComposed CreateCurrentPixel()
        {
        ...
        /// </summary>
        private string GetPixelTypeName(PixelElementComposed pixel)
        {
