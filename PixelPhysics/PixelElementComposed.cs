...
/// </summary>
public class PixelElementComposed
{
    public delegate void PixelAction(PixelElementComposed pixel, Vector2I position);
    ...
    public virtual bool IsEmpty(PixelElementComposed element)
    {
    ...
    public virtual PixelElementComposed Clone()
    {
        PixelElementComposed clone = (PixelElementComposed)MemberwiseClone();
        return clone;
    }
    ...
    public (Vector2I Current, Vector2I Next) FindNextPixelPosition(Vector2I origin, List<Vector2I> coords, PixelChunk chunk, Vector2I direction, int randomRangeOffset = 10)
    {
        ...
        foreach (Vector2I coord in coords)
        {
            ...
            if (pixel is PixelElementComposed composedPixel)
            {
