...
public class LiquidFlowBehavior : IMovementBehavior
{
    ...
    private (Vector2I Current, Vector2I Next) FindNextPixelPosition(Vector2I origin, List<Vector2I> coords, PixelChunk chunk, Vector2I direction, PixelElementComposed pixel)
    {
    ...
    private bool IsEmpty(object pixelAtPosition, PixelElementComposed currentPixel)
    {
        if (pixelAtPosition is PixelElementComposed composedPixel)
        {
